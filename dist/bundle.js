...
/***/ function(module, exports, __webpack_require__) {
	...
	var createStoreWithMiddleware = (0, _redux.applyMiddleware)((0, _reduxLogger2.default)(), _reduxPromise2.default)(_redux.createStore);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _photo_list = __webpack_require__(200);

	var _photo_list2 = _interopRequireDefault(_photo_list);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_photo_list2.default, null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PhotoList = function (_Component) {
	  ...
	  _createClass(PhotoList, [{
	    ...
	    value: function handleInputChange(search) {
	      ...
	      if (this.props.photos instanceof Array && this.props.photos.length > 0) {
	        return this.props.photos.map(function (photo) {
	          return _react2.default.createElement(
	            ...
	            _react2.default.createElement('img', { src: photo.webformatURL })
	          );
	        });
	      } else if (this.props.photos instanceof Array && this.props.photos.length === 0) {
	        return [{ webformatURL: 'https://static.pexels.com/photos/12570/photo-1443926818681-717d074a57af.jpeg' }].map(function (photo) {
	          return _react2.default.createElement(
	            'li',
	            {
	              key: photo.imageurl,
	            ...
	            _react2.default.createElement(
	              'p',
	              { className: 'extraMessage' },
	              'No photos found, try something else...'
	            ),
	            _react2.default.createElement('img', { src: photo.webformatURL })
	          );
	        });
	        ...
	        return [{ webformatURL: 'https://static.pexels.com/photos/12570/photo-1443926818681-717d074a57af.jpeg' }].map(function (photo) {
	          return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'p',
	              { className: 'extraMessage' },
	              'Welcome, search for images if you please...'
	            ),
	            _react2.default.createElement('img', { src: photo.webformatURL })
	          );
	        });
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'list-group-item searchDiv' },
	        _react2.default.createElement(
	          'h1',
	          { className: 'mainHeader' },
	          'React.JS Redux Image Search...'
	        ),
	        ...
	        _react2.default.createElement('input', { type: 'button', className: 'searchButton', value: 'Search images...', onClick: function onClick() {
	            _this2.props.searchPhotos(_this2.state.search);
	...
	function mapDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({
	    searchPhotos: _index.searchPhotos
	  }, dispatch);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pixaBayApi = 'https://pixabay.com/api/?key=2127791-7f5f0bdaf801a285b56d69550&q=';
	var apiConfig = '&image_type=photo&safesearch=false&per_page=100';

	function searchPhotos(search_term) {
	  var search_photo_request = _axios2.default.get('' + pixaBayApi + search_term + apiConfig);
	  return {
	    type: 'SEARCH_PHOTOS',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var btoa = (typeof window !== 'undefined' && window.btoa) || __webpack_require__(213);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _photo_search_reducer = __webpack_require__(222);

	var _photo_search_reducer2 = _interopRequireDefault(_photo_search_reducer);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({
	  photos: _photo_search_reducer2.default
	});
